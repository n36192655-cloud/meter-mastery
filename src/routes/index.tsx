...
function Dashboard() {
  const { customers, meters, readings, bills, payments, productionLogs, hydrateFromSupabase } = useStore();
  ...
  }, [customers, meters, readings, bills, payments, productionLogs]);
    ...
    <div className="space-y-6" dir="rtl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2 mt-3 text-[11px]">
            <MiniStat label="قراءات منتظمة" value={fmtNum(readings.length - k.suspiciousCount)} />
        ...
        >
          ...
          <div className="mt-1 text-[10px] text-muted-foreground">
            {fmtNum(bills.length)} فاتورة · {fmtNum(k.paymentsCount)} دفعة
          </div>
        </KpiCard>
